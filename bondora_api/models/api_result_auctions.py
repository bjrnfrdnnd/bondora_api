...
class ApiResultAuctions(object):
    ...
    def __init__(self, page_size=None, page_nr=None, total_count=None, count=None, payload=None, success=None, errors=None):  # noqa: E501
        """ApiResultAuctions - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def page_size(self):
        """Gets the page_size of this ApiResultAuctions.  # noqa: E501

        Requested Max items in result  # noqa: E501

        :return: The page_size of this ApiResultAuctions.  # noqa: E501
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        ...
        :param page_size: The page_size of this ApiResultAuctions.  # noqa: E501
        :type: int
        """
    ...
    @property
    def page_nr(self):
        """Gets the page_nr of this ApiResultAuctions.  # noqa: E501

        Requested page nr  # noqa: E501

        :return: The page_nr of this ApiResultAuctions.  # noqa: E501
        :rtype: int
        """
    ...
    def page_nr(self, page_nr):
        ...
        :param page_nr: The page_nr of this ApiResultAuctions.  # noqa: E501
        :type: int
        """
    ...
    def total_count(self):
        """Gets the total_count of this ApiResultAuctions.  # noqa: E501

        Total number of items found  # noqa: E501

        :return: The total_count of this ApiResultAuctions.  # noqa: E501
        :rtype: int
        """
    ...
    def total_count(self, total_count):
        ...
        :param total_count: The total_count of this ApiResultAuctions.  # noqa: E501
        :type: int
        """
    ...
    @property
    def count(self):
        """Gets the count of this ApiResultAuctions.  # noqa: E501

        Number of items returned  # noqa: E501

        :return: The count of this ApiResultAuctions.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        ...
        :param count: The count of this ApiResultAuctions.  # noqa: E501
        :type: int
        """
        if count is None:
    ...
    @property
    def payload(self):
        """Gets the payload of this ApiResultAuctions.  # noqa: E501

        The payload of the response. Type depends on the API request.  # noqa: E501

        :return: The payload of this ApiResultAuctions.  # noqa: E501
        :rtype: list[Auction]
        """
    ...
    def payload(self, payload):
        ...
        :param payload: The payload of this ApiResultAuctions.  # noqa: E501
        :type: list[Auction]
        """
    ...
    def success(self, success):
        ...
        :param success: The success of this ApiResultAuctions.  # noqa: E501
        :type: bool
        """
        if success is None:
    ...
    @property
    def errors(self):
        """Gets the errors of this ApiResultAuctions.  # noqa: E501

        Error(s) accociated with the API request.  # noqa: E501

        :return: The errors of this ApiResultAuctions.  # noqa: E501
        :rtype: list[ApiError]
        """
        return self._errors
    ...
    def errors(self, errors):
        ...
        :param errors: The errors of this ApiResultAuctions.  # noqa: E501
        :type: list[ApiError]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiResultAuctions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiResultAuctions):
            return False
